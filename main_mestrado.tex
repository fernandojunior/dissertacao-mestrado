...
\usepackage{pdfpages} %Adicionar páginas em pdf
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\Titulo{Caracterização de Perfis de Comportamento de Equipes em League of Legends}
\Autor{Fernando Felix do Nascimento Junior}
\Data{15/12/2017}
\Area{Ciência da Computação}
\Pesquisa{Mineração de Dados}
\Orientadores{Leandro Balby Marinho  \\
	 (Orientador)}
...
% ------ Ficha catalográfica ------ %
\includepdf[offset=-13mm 0mm]{ficha_catalografica.pdf}
% --------------------------------- %
