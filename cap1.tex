...
A Figura ~\ref{fig:relevance} ilustra o mapa de calor da análise de relevância das características com base no cálculo do ganho de informação aplicado ao conjunto de métricas de desempenho das equipes sem normalização (realizado na seção 4.6) $M$ para indicar como eles influenciam cada \fj{grupo}{perfil}.
