...
\begin{table*}
  \tiny
  \caption{Centróides das características (métricas de desempenho) para cada um dos 7 perfis encontrados. As últimas 5 colunas da tabelas sumarizam as métricas de desempenho entre os perfis: valor mínimo (Min), média (Mean), variância (Var), desvio padrão (Sd), valor máximo (Max).}
  \label{tab:centers}
