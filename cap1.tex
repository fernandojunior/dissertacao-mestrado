...
\begin{enumerate}[label=(\roman*)]
  \item É possível computar métricas de desempenho de equipes em LoL?
  \item É possível encontrar padrões úteis de comportamento de equipes com base nessas métricas?
...
As descobertas do nosso estudo sugerem alguns elementos muito concretos que podem ser usados para enriquecer as estratégias de equipes inexperientes de LoL. Ao analisar o desempenho dos perfis de sucesso, uma equipe inexperiente poderia avaliar suas métricas de desempenho nas partidas para apoiar suas decisões conforme o perfil em que mais se adequa. Vamos supor que uma equipe não tenha evidenciado uma determinada métrica de desempenho em suas partidas por algum motivo, como \textit{totalHeal}, no entanto, ao analisar os perfis de sucesso, a equipe percebe que a pontuação \textit{totalHeal} dos perfis de sucesso tem um nível muito alto e que a pontuação dessa métrica em um nível alto pode ter alguma relevância para melhorar o desempenho da equipe nas partidas.
