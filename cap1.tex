...
\begin{table}
  ...
  \begin{tabular}{p{0.30\textwidth}p{0.65\textwidth}}
    ...
    \midrule
physicalDamageDealtToChampions & physicalDamageDealt - physicalDamageDealtToChampions\\
...
Para transformar os dados, realizamos as seguintes tarefas: normalização de dados e cálculo de métricas.
...
\caption{Mapa de calor das relevâncias das métricas desempenho das equipes com base no ganho de informação. \fj{}{Quanto mais forte for a cor de uma caracter\'istica, mais intensa \'e a relevância dessa caracter\'istica.}}
\label{fig:relevance}
\end{figure*}
